<script>
  ...
  {#if nextButtonClicked && nextPageButton && nextPageButton2 && !nextPageButton4}
      <button type="button" on:click={goToP4}>P4</button>
  {/if}
  ...
  {#if nextPageButton4}
      ...
      <div style="display: flex; align-items: center;">
          ...
          <p>Value Hypothesis: Will customer see value in your offering and buy it​</p>
      </div>
  {/if}
